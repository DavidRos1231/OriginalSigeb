...
<div class="container mt-3">
    ...
    <div class="row justify-content-center" style="width: 75%; max-width: 1000px; height: 505px; margin-top: 50px; margin-left: 150px; border-radius: 15px;
        ...
        <div class="col-4">
            ...
            <form action="actualizar-libro" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="${libro.id}">
                <div class="mb-3">
                    <label for="controlName" class="form-label">Nombre: </label>
                    <input type="text" class="form-control" id="controlName" name="name" value="${libro.name}">
                </div>
                <div class="mb-3">
                    <label for="controlAutor" class="form-label">Autor: </label>
                    <input type="text" class="form-control" id="controlAutor" name="autor" value="${libro.autor}">
                 </div>
                <div class="mb-3">
                    <label for="controlCategoria" class="form-label">Categoria: </label>
                    <input type="text" class="form-control" id="controlCategoria" name="categoria" value="${libro.categoria}">
                 </div>
                <br>
                <button type="submit" class="btn btn-success">Registrar</button>
                <a href="list-libros" class="btn btn-danger">Cancelar</a>
            </form>
