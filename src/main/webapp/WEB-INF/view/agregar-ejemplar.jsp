...
<div class="container mt-3">
    <div class="col-12">
        <h1 class="text-center">Entregar Ejemplar</h1>
    </div>
    ...
    <div class="row justify-content-center" style="width: 75%; max-width: 1000px; height: 505px; margin-top: 150px; margin-left: 150px; border-radius: 15px;
        ...
        <div class="col-4">
            ...
            <form action="guardar-ejemplar" method="post">
                ...
                <div class="mb-3">
                    <label for="controlEditorial" class="form-label">Editorial: </label>
                    <input type="text" class="form-control" id="controlEditorial" name="editorial">
                 </div>
                <input type="hidden" value="${id}" name="id">
                <div>
                    <label for="cantidad" class="form-label">Cantidad de ejemplares</label>
                    <input type="number" class="form-control" id="cantidad" name="cantidad" placeholder="1-10">
                </div>
                <br>
